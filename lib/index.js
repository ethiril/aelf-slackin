  ...
  app.get('/', (req, res) => {
    ...
    let page = dom('html',
      dom('head',
        ...
        dom("script src=https://code.jquery.com/jquery-1.9.1.min.js"),
        dom('meta name=viewport content="width=device-width,initial-scale=1.0,minimum-scale=1.0,user-scalable=no"'),
        dom('link rel="shortcut icon" href=https://aelf.io/favicon.ico'),
      ...
      if (err) {
        ...
        if(resp.body.success){
          ...
          invite({ token, org, email, channel: chanId }, err => {
            ...
            res
            .status(200)
            .json({ msg: 'Awesome! Now check your email!' })
          });
